...
const ExperienceItem = ({ experience }) => (
  <div className="flex flex-col sm:flex-row mt-4">
    ...
    <div className="text-neutral-800 dark:text-neutral-100">
      ...
      <p className="text-neutral-700 dark:text-neutral-300">{experience.description}</p>
      <p className="text-xs mt-2 text-neutral-900 dark:text-neutral-100">{experience.technologies}</p>
    </div>
  </div>
);
